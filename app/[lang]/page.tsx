        ...
        <div className="inner">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              <h4>{d.footer.company}</h4>
              <a href={`/${lang}/about`}>{d.footer.about}</a>
              <a href="/blog">{d.nav.blog}</a>
              <a href={`/${lang}#faq`}>FAQ</a>
              <a href={`/${lang}#contact`}>{d.nav.contact}</a>
            </div>

            <div className="footer-col">
              <h4>{d.footer.platforms}</h4>
              <a href={`/${lang}#products`}>EasyNuP</a>
              <a href={`/${lang}#products`}>NuPIdentify</a>
              <a href={`/${lang}#products`}>Debug Probe</a>
              <a href={`/${lang}#products`}>Sentinel</a>
            </div>

            <div className="footer-col">
              <h4>{d.footer.aiTools}</h4>
              <a href={`/${lang}#products`}>Manifest</a>
              <a href={`/${lang}#products`}>NuP-Chunks</a>
              <a href="https://github.com/nuptechs" target="_blank" rel="noopener noreferrer">GitHub</a>
            </div>
          </div>

          <div className="footer-bottom">
            <p>© 2022&ndash;{new Date().getFullYear()} NuPtechs. {d.footer.rights}</p>
