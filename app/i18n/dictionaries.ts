  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How does NuPtechs ensure code quality?", a: "Automated tests across every layer (unit, integration, e2e), CI/CD with lint, build, and test pipelines, structured code review, and automated security analysis with NuP-Manifest. No code goes to production without passing the full pipeline." },
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cómo garantiza NuPtechs la calidad del código?", a: "Tests automatizados en todas las capas (unitarios, integración, e2e), CI/CD con pipelines de lint, build y test, code review estructurado y análisis de seguridad automatizado con NuP-Manifest. Ningún código va a producción sin pasar por la pipeline completa." },
