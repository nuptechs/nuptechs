  ...
  "@graph": [
    {
      ...
      url: siteUrl,
      name: "NuPtechs",
      description: "Engenharia de software para infraestrutura empresarial. 15 produtos próprios em produção e 70+ projetos entregues, com consultoria oficial em Arquitetura TOGAF, auditoria à prova de adulteração e operação on-premise.",
...
const faqs = [
  ...
  { q: "Como a NuPtechs garante qualidade do código?", a: "Testes automatizados em todas as camadas (unit, integration, e2e), CI/CD com pipelines de lint, build e teste, code review estruturado e análise de segurança automatizada com o NuP-Manifest. Nenhum código vai para produção sem passar por toda a pipeline." },
          ...
          <div className="hero-eng-layout">
            <div className="hero-copy hero-copy--left">
              ...
              <p className="lead" data-reveal style={{ transitionDelay: '300ms' }}>
                +70 projetos entregues e 15 produtos próprios em produção — entre SaaS, plataformas e bibliotecas. Engenharia pronta para o setor público: consultoria oficial em Arquitetura TOGAF, auditoria à prova de adulteração e operação on-premise.
              </p>
              ...
              <div className="hero-proof-row" data-reveal data-reveal-group style={{ transitionDelay: '650ms' }}>
                ...
                <div className="hero-proof-card" data-reveal-item>
                  <span className="hero-proof__kpi">TOGAF</span>
                  <span className="hero-proof__label">Consultoria Oficial em Arquitetura</span>
                </div>
                <div className="hero-proof-card" data-reveal-item>
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div data-reveal="left">
              ...
              <div className="flex flex-col gap-4 text-sm text-[var(--muted)]">
                ...
                <a href="https://wa.me/556285507649" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-[var(--text)] transition-colors">
                ...
                <a href="https://t.me/+556285507649" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-[var(--text)] transition-colors">
