  ...
  "@graph": [
    {
      ...
      url: siteUrl,
      name: "NuPtechs",
      description: "Engenharia de software para infraestrutura empresarial. 13 produtos próprios em produção e 70+ projetos entregues, com consultoria oficial em Arquitetura TOGAF, auditoria à prova de adulteração e operação on-premise.",
          ...
          <div className="hero-eng-layout">
            <div className="hero-copy hero-copy--left">
              ...
              <p className="lead" data-reveal style={{ transitionDelay: '300ms' }}>
                +70 projetos entregues e 13 produtos próprios em produção — entre SaaS, plataformas e bibliotecas. Engenharia pronta para o setor público: consultoria oficial em Arquitetura TOGAF, auditoria à prova de adulteração e operação on-premise.
              </p>
