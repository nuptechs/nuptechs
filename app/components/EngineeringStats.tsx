...
const stats: Stat[] = [
  { value: 70, suffix: "+", label: { pt: "projetos entregues", en: "projects delivered", es: "proyectos entregados" }, sublabel: { pt: "para governo e enterprise", en: "for government and enterprise", es: "para gobierno y enterprise" } },
