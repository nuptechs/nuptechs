...
const footerCopy = {
  pt: {
    ...
    proofPoints: ["+70 projetos entregues", "13 produtos em produção", "conformidade 14.133/13.303 e LGPD"],
    company: "Empresa",
    services: "Serviços",
    products: "Produtos",
  ...
  en: {
    ...
    secondaryCta: "WhatsApp",
    proofPoints: ["70+ projects shipped", "13 live products", "Laws 14.133/13.303 & LGPD compliant"],
    company: "Company",
    services: "Services",
    products: "Products",
  ...
  es: {
    ...
    primaryCta: "Solicitar diagnóstico",
    secondaryCta: "WhatsApp",
    proofPoints: ["70+ proyectos entregados", "13 productos en producción", "conforme a las Leyes 14.133/13.303 y LGPD"],
    company: "Empresa",
    services: "Servicios",
    products: "Productos",
