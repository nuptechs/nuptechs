...
const footerCopy = {
  pt: {
    ...
    proofPoints: ["+70 projetos entregues", "13 produtos em produção", "conformidade Lei 14.133 e LGPD"],
    company: "Empresa",
    services: "Serviços",
    products: "Produtos",
  ...
  en: {
    ...
    secondaryCta: "WhatsApp",
    proofPoints: ["70+ projects shipped", "13 live products", "Law 14.133 & LGPD compliant"],
    company: "Company",
    services: "Services",
    products: "Products",
  ...
  es: {
    ...
    primaryCta: "Solicitar diagnóstico",
    secondaryCta: "WhatsApp",
    proofPoints: ["70+ proyectos entregados", "13 productos en producción", "conforme a la Ley 14.133 y LGPD"],
    company: "Empresa",
    services: "Servicios",
    products: "Productos",
