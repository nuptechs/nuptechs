...
const footerCopy = {
  pt: {
    ...
    proofPoints: ["+70 projetos entregues", "13 produtos em produção", "Consultoria Oficial em Arquitetura TOGAF"],
    company: "Empresa",
    services: "Serviços",
    products: "Produtos",
  ...
  en: {
    ...
    secondaryCta: "WhatsApp",
    proofPoints: ["70+ projects shipped", "13 live products", "Official TOGAF architecture consulting"],
    company: "Company",
    services: "Services",
    products: "Products",
  ...
  es: {
    ...
    primaryCta: "Solicitar diagnóstico",
    secondaryCta: "WhatsApp",
    proofPoints: ["70+ proyectos entregados", "13 productos en producción", "Consultoría Oficial en Arquitectura TOGAF"],
    company: "Empresa",
    services: "Servicios",
    products: "Productos",
