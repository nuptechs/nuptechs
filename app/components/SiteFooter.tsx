...
const footerCopy = {
  pt: {
    ...
    proofPoints: ["+200 projetos entregues", "15 produtos em produção", "conformidade Lei 14.133 e LGPD"],
    company: "Empresa",
    services: "Serviços",
    products: "Produtos",
  ...
  en: {
    ...
    secondaryCta: "WhatsApp",
    proofPoints: ["200+ projects shipped", "15 live products", "Law 14.133 & LGPD compliant"],
    company: "Company",
    services: "Services",
    products: "Products",
  ...
  es: {
    ...
    primaryCta: "Solicitar diagnóstico",
    secondaryCta: "WhatsApp",
    proofPoints: ["200+ proyectos entregados", "15 productos en producción", "conforme a la Ley 14.133 y LGPD"],
    company: "Empresa",
    services: "Servicios",
    products: "Productos",
