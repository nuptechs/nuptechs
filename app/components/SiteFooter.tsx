...
const footerCopy = {
  pt: {
    ...
    proofPoints: ["+200 projetos entregues", "15 produtos em produção", "1,2M+ linhas de código"],
    company: "Empresa",
    services: "Serviços",
    products: "Produtos",
  ...
  en: {
    ...
    secondaryCta: "WhatsApp",
    proofPoints: ["200+ projects shipped", "15 live products", "1.2M+ LOC in production"],
    company: "Company",
    services: "Services",
    products: "Products",
  ...
  es: {
    ...
    primaryCta: "Solicitar diagnóstico",
    secondaryCta: "WhatsApp",
    proofPoints: ["200+ proyectos entregados", "15 productos en producción", "1,2M+ líneas de código"],
    company: "Empresa",
    services: "Servicios",
    products: "Productos",
