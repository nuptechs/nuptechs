...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/salao/dono/", destination: "/salao/dono/index.html" },
      // Painel do Dono — segmentos extra
      { source: "/petshop", destination: "/petshop/dono/index.html" },
      { source: "/petshop/", destination: "/petshop/dono/index.html" },
      { source: "/petshop/dono", destination: "/petshop/dono/index.html" },
      { source: "/petshop/dono/", destination: "/petshop/dono/index.html" },
      { source: "/ferragista", destination: "/ferragista/dono/index.html" },
      { source: "/ferragista/", destination: "/ferragista/dono/index.html" },
      { source: "/ferragista/dono", destination: "/ferragista/dono/index.html" },
      { source: "/ferragista/dono/", destination: "/ferragista/dono/index.html" },
      { source: "/acougue", destination: "/acougue/dono/index.html" },
      { source: "/acougue/", destination: "/acougue/dono/index.html" },
      { source: "/acougue/dono", destination: "/acougue/dono/index.html" },
      { source: "/acougue/dono/", destination: "/acougue/dono/index.html" },
      { source: "/mercado", destination: "/mercado/dono/index.html" },
      { source: "/mercado/", destination: "/mercado/dono/index.html" },
      { source: "/mercado/dono", destination: "/mercado/dono/index.html" },
      { source: "/mercado/dono/", destination: "/mercado/dono/index.html" },
